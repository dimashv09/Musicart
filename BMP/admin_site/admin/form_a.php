...
{
    $tgl=explode("-",$tanggal);
    mysqli_query($con,"update agenda set tanggal='$tgl[2]-$tgl[1]-$tgl[0]',waktu='$waktu',tempat='$tempat',acara='$acara' where id='$id'");
    echo "
    <script>
               ...
               <input type="hidden" name="id" value="<?php echo isset($data[0])?$data[0]:''; ?>">
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="tgl_agenda" required value="<?php echo isset($_GET['id'])?"$tgl[2]-$tgl[1]-$tgl[0]":""; ?>" name="tanggal" class="form-control" id="inputEmail3" placeholder="tanggal">
                        </div>
                    </div>
                    <div class="form-group">
