...
if(isset($_POST['save']))
{
    mysqli_query($con,"insert into playlist values('','$judul','$penyanyi','$playlist')");
    echo "
    <script>
    location.assign('index.php?page=playlist&ps=true2');
    </script>
    ";
}
...
{
    $tgl=explode("-",$tanggal);
    mysqli_query($con,"update playlist set judul='$judul',penyanyi='$penyanyi',playlist='$playlist' where id='".$_GET['id']."'");
    echo "
    <script>
    location.assign('index.php?page=playlist&ps=true1');
    </script>
    ";
}
...
if(isset($_GET['id']))
{
    $data=mysqli_fetch_row(mysqli_query($con,"select * from playlist where id='".$_GET['id']."'"));
}
    ...
    <div class="col-md-12">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Form Input playlist</h3>
            </div>
            <form class="form-horizontal" method="post">
               <input type="hidden" name="id" value="<?php echo isset($data[0])?$data[0]:''; ?>">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="tiga" class="col-sm-2 control-label">playlist</label>
                        <div class="col-sm-10">
                            <input type="text" required value="<?php echo isset($data[3])?$data[3]:''; ?>" name="playlist" class="form-control" id="tiga" placeholder="Link playlist">
                        </div>
                    </div>
                </div>
                <!-- /.box-body -->
