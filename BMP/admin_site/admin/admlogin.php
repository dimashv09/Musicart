...
if(isset($login)){
	if(mysqli_num_rows(mysqli_query($con,"select username from admin where username='$user' and password='$pass'")))
    {
        $tipe=mysqli_fetch_row(mysqli_query($con,"select username from admin where username='$user' and password='$pass'"));
...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Admin Bagaskara Musicart Project</title>
